...
const Contact = () => {
    ...
    return (
        <div className="w-full h-screen flex flex-wrap items-center justify-center lg:mx-auto w-full lg:w-3/4 px-4 lg:px-0" id="contact">
            <div className="w-full"> 
                <h2 className="md:text-center text-3xl leading-8 font-extrabold tracking-tight sm:text-4xl t-violet mb-8">Contatti</h2>
                <form action="post" url="" onSubmit={submit} className="flex flex-wrap justify-between" >
